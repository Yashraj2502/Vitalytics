...
public class LowPassTransform {
    ...
    public LowPassTransform(double fc, LayoutBase m_digitalProto, Butterworth.AnalogLowPass m_analogProto, double f) {
        this.f = f;
    }
    ...
    public LowPassTransform(double fc, LayoutBase digital, Butterworth.AnalogLowPass analog) {
        digital.reset();
