package com.example.vitalytics.Math;
...
import com.example.vitalytics.Math.BandPassTransform;
import com.example.vitalytics.Math.BandStopTransform;
import com.example.vitalytics.Math.LayoutBase;
 ...
 */
public class Bessel extends com.example.vitalytics.Math.Cascade {
    ...
    class AnalogLowPass extends com.example.vitalytics.Math.LayoutBase {
    ...
    private void setupLowPass(int order, double sampleRate,
        ...
        com.example.vitalytics.Math.LayoutBase m_digitalProto = new com.example.vitalytics.Math.LayoutBase(order);
//
//        new com.example.vitalytics.Math.LowPassTransform(cutoffFrequency / sampleRate, m_digitalProto,
//                m_analogProto);
    ...
    public void lowPass(int order, double sampleRate, double cutoffFrequency) {
        setupLowPass(order, sampleRate, cutoffFrequency,
                com.example.vitalytics.Math.DirectFormAbstract.DIRECT_FORM_II);
    }
    ...
    private void setupHighPass(int order, double sampleRate,
        ...
        new com.example.vitalytics.Math.HighPassTransform(cutoffFrequency / sampleRate, m_digitalProto,
                m_analogProto);
    ...
    private void setupBandStop(int order, double sampleRate,
        ...
        com.example.vitalytics.Math.LayoutBase m_digitalProto = new com.example.vitalytics.Math.LayoutBase(order * 2);
