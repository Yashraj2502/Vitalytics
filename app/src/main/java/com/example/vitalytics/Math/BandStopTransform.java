...
public class BandStopTransform {
    ...
    public BandStopTransform(double fc, double fw, LayoutBase m_digitalProto, Butterworth.AnalogLowPass m_analogProto, double a, double b, double a2, double b2) {
        this.a = a;
        this.b = b;
        this.a2 = a2;
        this.b2 = b2;
    ...
    private ComplexPair transform(Complex c) {
        ...
        v = v.add(a);
        MathSupplement.addmul(v, -a, c);

        u = u.multiply(.5);
        u = u.add(a);
        MathSupplement.addmul(u, -a, c);

        Complex d = new Complex(b + 1);
        MathSupplement.addmul(d, b - 1, c);
