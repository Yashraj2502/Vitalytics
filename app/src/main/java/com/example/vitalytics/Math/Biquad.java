...
public class Biquad {
    ...
    public void setPoleZeroForm(com.example.vitalytics.Math.BiquadPoleState bps) {
        setPoleZeroPair(bps);
        applyScale(bps.gain);
    }
    ...
    public void setPoleZeroPair(com.example.vitalytics.Math.BiquadPoleState pair) {
